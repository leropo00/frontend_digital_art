<template>
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        <h2 class="text-base/7 font-semibold text-gray-900">Create a new Reference material</h2>
                ...
                <div class="mt-6 space-y-4">
                    <div class="flex items-center gap-x-3">
                        <input id="reference-material-type-image" name="reference-material-type" type="radio" 
                            :value="REFERENCE_TYPE_IMAGE" v-model="referenceMaterialData.reference_material_type" checked="" 
